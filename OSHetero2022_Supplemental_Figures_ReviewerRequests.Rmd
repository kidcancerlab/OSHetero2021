...
```{r repfig3d_process, dependson='repfig3c', eval=T}
source("Downstream.v3.R")
library(data.table)
#library(pheatmap)
...
pdf("Figures/supplement/requests/k7m2_f420/repfigure_3d.pdf",
       width = 15,
       height = 8)
repfigure_3d
dev.off()
...
*Note: this code chunk depends on objects created in OSHetero2021_Supplemental_Figures.Rmd*

```{r patientvpdx}
library(harmony)
# Start from this stopping point from OSHetero2021_Supplemental_Figures.Rmd
...
```{r cellpdx_scatter}
load("Data/Supplement/PatientData/OS.list_1500_ms.RData")
...
for (j in 1:3) {
  ...
  pdf(file = paste0("Figures/supplement/requests/cellms/cellscatter_",
                    j+5,
                    ".pdf"),
      height=13,
      width=15)
...
pdf(file = paste0("Figures/supplement/requests/cellms/cellscatter_9.pdf"),
    height=13,
    width=15)
print(sfig)
dev.off()
