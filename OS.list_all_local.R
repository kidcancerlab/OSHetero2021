...
OB <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0031-Osteoblasts/filtered_feature_bc_matrix/", spec = "human")
OB <- subset(OB, subset = nCount_RNA <20000 & percent.mt <10)
OB$src <- "OB"
OB$cond <- "OB"

#OS17
os17.cx.raw <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0016-zymo/filtered_feature_bc_matrix/", spec = "mixHuman")
...
os17.tib.raw <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0018xS0028/filtered_feature_bc_matrix/", spec = "mixHuman")
...
os17.lung.raw <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0024xS0029/filtered_feature_bc_matrix/", spec = "mixHuman")
...
#NCHOS2
OS2.cx.raw <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0076/filtered_feature_bc_matrix/", spec = "mixHuman")
...
#NCHOS7
OS7.cx.raw <- tenXLoadQC(path10x = "R:/RESRoberts/Bioinformatics/scRNAOuts/S0043-NCHOS7-flank/filtered_feature_bc_matrix/", spec = "mixHuman")
...
save(OS.list, file = "R:/RESRoberts/Bioinformatics/Analysis/Sanjana/2020/OS.list_PC50.RData")
