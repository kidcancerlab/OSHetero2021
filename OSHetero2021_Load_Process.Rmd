...
os17.lung.raw$model <- "OS17"
```

### Process OS17 culture for Figure 1

```{r Fig1a1_process, dependson='load_os17'}
...
OS7.lung.raw$model <- "NCHOS7"
```

### Process NCHS-OS7 flank for Figure 1

```{r Fig1a3_process, dependson='load_nchos7'}
...
```{r mergeallobj, dependson=c('load_ob','load_os17','load_t143b','load_nchos2','load_nchos7')}
# Merge into a single Seurat object
