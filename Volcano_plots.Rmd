...
```{r load, cache=TRUE}
#From Fig1
load("Data/os17.cx_CCR.RData") #os17.cx
load(file ="Data/OS7.cx_CCR.RData") #OS7.cx
...
OS_list$NCHOS7_TL <- OS_list$NCHOS7_TL %>%
    FindClusters(resolution = 0.2)
# From Fig5
load("/home/gdrobertslab/rsexf001/OSHetero2021/Data/os17.RData") # from figure 5 (culture, tibia, lung)
...
for(c in names(clusters)) {
  for(m in de_methods) {
    plots[[c]][[m]]$panel <-
      ...
      plots[[c]][[m]]$MF +
      plots[[c]][[m]]$CC)
    pdf(paste0("/gpfs0/home2/gdrobertslab/rsexf001/OSHetero2021/figures/supplement/Volcano_plots/panel-",
              tumor_name,
              "-",
              m,
              "-",
