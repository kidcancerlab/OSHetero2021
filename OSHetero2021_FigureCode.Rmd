...
# There are cells in lung/tibia that cluster with the culture cells and throw off the DimPlots
...
figure_5c1 <-
  process_ltbc(os17_cx_raw,
               ...
               relative = TRUE,
               ret_list = TRUE) %>%
  ltbc_hist(fill = "#E64B35FF", n_uniq_1, "Culture, Top 40 Clones")
...
figure_5c2 <- process_ltbc(os17_tib_raw,
                           ...
                           relative = TRUE,
                           ret_list = TRUE) %>%
  ltbc_hist(fill = "#00A087FF", n_uniq_2, "Tibia, Top 40 Clones")
...
figure_5c3 <- process_ltbc(os17_lung_raw,
                           ...
                           relative = TRUE,
                           ret_list = TRUE) %>%
  ltbc_hist(fill = "#4DBBD5FF", n_uniq_3, "Lung, Top 40 Clones")
