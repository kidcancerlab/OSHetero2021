...
rplot <- ggplot(ith, aes(x = logITH, y = Sample, fill = Sample)) +
  ...
  theme(legend.position = "none",
        axis.text.y = element_text(size = f3_axis_text_size),
        axis.text.x = element_text(size = f3_axis_text_size),
        axis.title.x = element_text(hjust = 0.5, size = f3_axis_title_size),
...
P2 <-
  ...
  theme(axis.text.x = element_blank(),
        axis.ticks.x = element_blank(),
        axis.title.y = element_text(size = f3_axis_title_size),
