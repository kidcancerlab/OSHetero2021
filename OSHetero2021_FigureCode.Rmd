...
figure_5c1 <- process_ltbc(os17_cx_raw,
...
cx_lt_list <- processLTBC(os17_cx_raw,
                          cid_lt = S0016xS0027_ltbc,
                          ret_list = TRUE)

tib_lt_list <- processLTBC(os17_tib_raw,
                           cid_lt = S0018xS0028_ltbc,
                           ret_list = TRUE)

lung_lt_list <- processLTBC(os17_lung_raw,
                            cid_lt = S0024xS0029_ltbc,
                            ret_list = TRUE)
