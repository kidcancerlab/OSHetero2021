...
ggsave("figures/figure_1/figure_1a_os17.pdf",
       plot = figure1_a1,
       width = 5,
       height = 5,
       units = "in",
...
ggsave("figures/figure_1/figure_1b_nchos7.pdf",
       plot = figure_1b,
       width = 5,
       height = 5,
       units = "in",
...
for (tissue_name in c("Tibia", "Lung")) {
    for (direction in c("up", "down")) {
        ...
        figure_2b[[paste0(tissue_name,
                          " - ",
                          direction)]]$layers[[3]]$data$x <- c(-1, -0.8, 0.8, 1)
    }
}
...
# Save plot
ggsave("figures/figure_2/figure_2b.pdf",
...
ggsave("figures/figure_2/figure_2c.pdf",
       plot = figure_2c,
       width = 6,
       height = 9)
...
ggsave("figures/figure_3/figure_3b.pdf",
       plot = figure_3b,
       width = 8,
       height = 8,
       device = "pdf")
...
for (s_obj in c(OS_list$`OS-17_TL`,
                ...
                OS_list$`NCH-OS-2_TL`,
                OS_list$`NCH-OS-7_TL`)) {
    s_obj$model <- factor(s_obj$model, levels = c("Tibia", "Lung"))
    lung_prop_tbl <-
        s_obj@meta.data %>%
        as_tibble() %>%
...
for (s_obj in sample_names) {
  ...
  ggsave(paste0("figures/figure_3/figure_3c1_",
                s_obj,
                ".pdf"),
       plot = combined_plot,
       width = 5,
...
for (sobj in objlist) {
  ...
  figure_3c2 <- ggplot(tident, aes(x = tissue, y = perc, fill = cluster)) +
    ...
    # Save plot
  ggsave(paste0("figures/figure_3/figure_3c2_",
                head(sobj$model,1),
                head(sobj$src, 1),
                ".pdf"),
       plot = figure_3c2,
...
ggsave("figures/figure_3/figure_3d.pdf",
       plot = figure_3d,
       width = 15,
       height = 8)
```
...
ggsave("figures/figure_5/figure_5b.pdf",
        plot = figure_5b,
        width = 8,
        height = 4,
        units = "in",
...
ggsave("figures/figure_5/figure_5c1.pdf",
        plot = figure_5c1,
        width = 8,
        height = 2,
        units = "in",
...
ggsave("figures/figure_5/figure_5c2.pdf",
        plot = figure_5c2,
        width = 8,
        height = 2,
        units = "in",
...
ggsave("figures/figure_5/figure_5c3.pdf",
        plot = figure_5c3,
        width = 8,
        height = 2,
        units = "in",
...
ggsave("figures/figure_5/figure_5c1_umap.pdf",
        plot = figure_5c1_umap,
        width = 3,
        height = 3,
        device = "pdf")
...
ggsave("figures/figure_5/figure_5c2_umap.pdf",
        plot = figure_5c2_umap,
        width = 3,
        height = 3,
        device = "pdf")
...
ggsave("figures/figure_5/figure_5c3_umap.pdf",
        plot = figure_5c3_umap,
        width = 3,
        height = 3,
        device = "pdf")
...
ggsave("figures/figure_5/figure_5e.pdf",
        plot = figure_5e,
        width = 6,
        height = 5,
        device = "pdf")
...
ggsave("figures/figure_5/figure_5f.pdf",
        width = 8,
        height = 3,
        device = "pdf")
```
